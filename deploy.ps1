...
try {
  ...
  $routes = @('$connect', '$disconnect', 'authenticate', 'conversations', 'createConversation', 'addGroupMember', 'removeGroupMember', 'createGroupInvite', 'previewGroupInvite', 'acceptGroupInvite', 'history', 'mediaUpload', 'send', 'react', 'setMute', 'report', 'registerPush', 'unregisterPush', '$default')
